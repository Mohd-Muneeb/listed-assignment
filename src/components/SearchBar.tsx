...
import search from "../../public/statussvg/search.svg";
		...
		<div className="flex w-full items-center justify-between">
			...
			<div className="flex items-center justify-center gap-8">
				<label className="relative flex items-center">
					<input className="rounded-lg bg-white p-2" onChange={(e: any) => setInputField(e.target.value)} placeholder="Search..."></input>
					<div className="absolute right-2" style={InputField !== "" ? { visibility: "hidden" } : {visibility: "visible"}}>
				...
				<button title="Sign out button" className="group" onClick={() => handleSignOut()}>
					<img
						src={
							...
							"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWH8bZEkYpeo_CfQx4qOTiJwLqEHI5rE8dVBHqPpM&s"
						}
